...
k *  to solve microstructural problems for composite materials.
 *
...
class test_t : public micropp {
	public:
		test_t(const int dim, const int size[3], const double micro_params[5],
		       const material_t mat_params[2])
			:micropp (dim, 4, size, 1, micro_params, mat_params)
		{};
		...
		{
			micropp::get_elem_nodes(n, ex, ey, ez);
		};
};
...
int main (int argc, char *argv[])
{
	...
	test_t test(3, size, micro_params, mat_params);
